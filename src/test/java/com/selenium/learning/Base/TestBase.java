package com.selenium.learning.Base;
...
public class TestBase {
	...
	public static final String ENV = System.getProperty("env", "user");
    ...
    public void suiteSetup() throws Exception {
	  ...
	  @BeforeMethod() public void loadBaseUrl(Method method) {
	...
	@AfterMethod
	  ...
	  public void screenshotAndDeleteCookies(ITestResult testResult) throws
	  IOException { //Taking screenshot in case of failure
	  if(testResult.getStatus() == ITestResult.FAILURE){ File scrFile =
	  ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
	  FileUtils.copyFile(scrFile, new
	  File("errorScreenshots\\" + testResult.getName() + "-" +
	  Arrays.toString(testResult.getParameters()) + ".jpg")); }}
	  
	  //Deleting cookies driver.manage().deleteAllCookies(); }
